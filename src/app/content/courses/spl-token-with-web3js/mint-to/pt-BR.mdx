...
console.log(
  `Contas de token criadas e tokens cunhados! Confira sua transação aqui: https://explorer.solana.com/tx/${signature}?cluster=devnet`,
);
```
...
console.log(
  `Cunhagem realizada com sucesso! Transação aqui: https://explorer.solana.com/tx/${tx}?cluster=devnet`,
);
```
