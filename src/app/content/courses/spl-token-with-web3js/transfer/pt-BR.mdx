...
console.log(
  `Tokens transferidos! Confira sua TX aqui: https://explorer.solana.com/tx/${signature}?cluster=devnet`,
);
```
...
console.log(
  `Transferência realizada com sucesso! Transação aqui: https://explorer.solana.com/tx/${tx}?cluster=devnet`,
);
```
