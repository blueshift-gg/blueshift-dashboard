...
<ArticleSection
  name="Розширення повноважень закриття монетного двору"
  id="mint-close-authority-config"
  level="h2"
/>
...
<ArticleSection
  name="Розширення стану облікового запису за замовчуванням"
...
<ArticleSection
  name="Розширення постійного делегата"
  id="permanent-delegate-extension"
  level="h2"
/>
