...
Có lẽ bạn đã từng sử dụng cách kiểm tra với macro `require!` của Anchor. Bạn có thể định nghĩa một macro tương tự trong chương trình Pinocchio của mình để đơn giản hóa việc kiểm tra lỗi:
...
Macro này kiểm tra một điều kiện và trả về lỗi được chỉ định nếu điều kiện đó sai, giúp mã của bạn gọn và dễ đọc hơn.
Với những kỹ thuật này, bạn có thể quản lý lỗi một cách hiệu quả trong các chương trình Pinocchio của mình, làm cho chúng mạnh mẽ và thân thiện với người dùng.

Sau đó, các kiểm tra từ chương `accounts` sẽ trông như sau:
