...
**Người dùng phổ thông** không biết hoặc không quan tâm đến blockchain. Họ muốn các ứng dụng "chỉ hoạt động". Bất kỳ sự khóa khăn nào vượt quá xác thực ứng dụng tiêu chuẩn đều không chấp nhận được.
...
Ví nhúng thay đổi quá trình gai nhập ban đầu bằng cách loại bỏ cụm từ khôi phục và phụ thuộc vào ví bên ngoài. Nhưng chúng cũng bị ràng buộc mối quan hệ với nhà cung cấp, cấu trúc chi phí mới, và các quyết định kiến trúc ảnh hưởng đến mô hình tin cậy của ứng dụng bạn.
