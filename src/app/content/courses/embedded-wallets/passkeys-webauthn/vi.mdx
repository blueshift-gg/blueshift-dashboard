...
SIMD-0075 đã thay đổi điều này bằng cách thêm một trình xác minh chữ ký secp256r1 được biên dịch sắn:
...
Việc hỗ trợ secp256r1 mở ra một một mô hình mạnh mẽ: Địa chỉ dẫn xuất chương trình (PDAs) được kiểm soát bởi chữ ký passkey.
...
Passkeys cải thiện đáng kể bảo mật so với mật khẩu và cụm từ khôi phục, nhưng không phải không có những điểu cần cân nhắc.
...
- **Các ví nhúng Passkey-authenticated**: Passkeys cũng cấp xác thực danh tính với hệ thống MPC hoặc hệ thống lưu ký
