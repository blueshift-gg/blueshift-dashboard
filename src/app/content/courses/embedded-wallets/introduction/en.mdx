...
> An embedded wallet isn't a compromise on security. Modern MPC and passkey-based systems can be _more_ secure than a seed phrase scribbled on paper and stuffed in a drawer.

<ArticleSection
  name="The Problem with Traditional Wallets"
