...
> Một ví nhúng không phải là sự thỏa hiệp về bảo mật. Các hệ thống MPC hiện đại và dựa trên passkey có thể _bảo mật hơn_ so với cụm từ khôi phục được viết nguệch ngoạc trên giấy và nhét trong ngăn kéo.

<ArticleSection
  name="Vấn đề của các ví truyền thống"
...
<ArticleSection
  name="Khi nào nên xem xét các lựa chọn thay thế"
  id="when-alternatives"
  level="h2"
/>
