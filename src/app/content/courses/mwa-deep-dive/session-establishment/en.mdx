...
**Qd (65 bytes)**: The dApp's _session_ public key (P-256, uncompressed format). This is different from the association public key. The dApp generates two keypairs.

**Sa (64 bytes)**: An ECDSA signature over Qd using the _association_ private key. This proves the dApp controls the association key from the URI.
