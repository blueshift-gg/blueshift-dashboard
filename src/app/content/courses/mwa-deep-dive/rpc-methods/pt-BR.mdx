...
```json
{
  ...
  "params": {
    "payloads": ["base64_encoded_transaction_1", "base64_encoded_transaction_2"],
    "options": {
...
```json
{
  ...
  "id": "4",
  "result": {
    "signatures": ["base64_encoded_signature_1", "base64_encoded_signature_2"]
  }
}
```
...
```json
{
  ...
  "params": {
    "payloads": ["base64_encoded_message"],
    "addresses": ["base64_encoded_pubkey"]
  }
}
```
...
```json
{
  ...
  "id": "5",
  "result": {
    "signed_payloads": ["base64_encoded_signed_message"]
  }
}
```
