...
Se você deseja aprender mais sobre quais funcionalidades adicionais estão disponíveis e quais são as diferenças em relação ao programa de Token legado, siga [este curso](/pt-BR/courses/token-2022-program)
