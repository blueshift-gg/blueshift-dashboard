...
Pour récupérer ensuite les frais, nous pouvons rassembler tous les `Token Account` qui contiennent des frais "piégés" et les passer comme compte restant (_remaining account_). Du côté de Typescript, cela ressemblerait à quelque chose comme ça :
