...
What makes NFTs _useful_ is the metadata: the name, image, attributes, and collection information. This metadata lives in a separate account managed by the Token Metadata program.
