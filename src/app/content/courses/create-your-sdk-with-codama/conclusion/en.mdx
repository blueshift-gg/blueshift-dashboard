...
Congratulations! You've completed the `Create your SDK with Codama` course. You now have a solid foundation in understanding how Codama IDL works, from its core concepts to practical implementation details.
