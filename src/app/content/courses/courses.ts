...
export const courses: CourseMetadata[] = withCourseNumber([
  ...
  {
    slug: "arithmetic-and-accounting-exploits",
    language: "General",
    color: BRAND_COLOURS.general,
    difficulty: 2,
    isFeatured: true,
    lessons: [
      { slug: "introduction" },
      { slug: "integer-math-safety" },
      { slug: "accounting-patterns" },
      { slug: "defi-math-exploits" },
      { slug: "conclusion" },
    ],
  },
  {
    slug: "protocol-level-attacks",
    language: "General",
    color: BRAND_COLOURS.general,
    difficulty: 3,
    isFeatured: true,
    lessons: [
      ...
      { slug: "first-depositor-and-share-attacks" },
      { slug: "flash-loan-attack-patterns" },
      { slug: "state-and-timing-vulnerabilities" },
      { slug: "denial-of-service-vectors" },
      { slug: "front-running-and-mev-on-solana" },
      { slug: "conclusion" },
    ],
  },
  {
    slug: "auditing-solana-programs",
    language: "General",
    color: BRAND_COLOURS.general,
    difficulty: 3,
    isFeatured: true,
    lessons: [
      ...
      { slug: "writing-proof-of-concept-exploits" },
      { slug: "severity-classification-and-reporting" },
      { slug: "conclusion" },
    ],
  },
  {
    slug: "formal-verification-with-kani",
    language: "General",
    color: BRAND_COLOURS.general,
    difficulty: 3,
    isFeatured: true,
    lessons: [
      { slug: "introduction" },
      { slug: "verification-concepts" },
      { slug: "kani-for-rust" },
      { slug: "verifying-solana-programs" },
      { slug: "conclusion" },
    ],
  },
]);
