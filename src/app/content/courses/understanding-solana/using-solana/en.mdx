...
Solana programs are written in Rust. Learn the language fundamentals first. Then study the Anchor framework, which simplifies Solana development with high-level abstractions for account validation, serialization, and error handling.
...
Learning sequence:
- [Anchor for Dummies](/courses/anchor-for-dummies) to learn the most popular Solana framework
- [Pinocchio for Dummies](/courses/pinocchio-for-dummies) for performance-critical programs
