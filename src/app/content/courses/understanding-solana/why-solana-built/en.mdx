...
# How Does Solana Work? Proof of History and Parallel Execution Explained

[Sequential execution](/courses/evolution-programmable-blockchains/scalability-challenge#sequential-execution-bottleneck) is blockchain's bottleneck. [Ethereum processes transactions one at a time](/courses/evolution-programmable-blockchains/ethereum-programmable-money#ethereum-virtual-machine) because it does not know which will conflict. Solana's insight: what if you could order everything first, then execute non-conflicting transactions in parallel?
