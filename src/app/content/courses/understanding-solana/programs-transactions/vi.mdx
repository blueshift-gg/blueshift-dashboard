...
Các chương trình xử lý các instruction, PDAs cho phép kiểm soát quyền hạn trên trên chương trình, các giao dịch cung cấp tính nguyên tử, và CPI cho phép các chương trình gọi lẫn nhau. Tiếp theo: xây dựng với Solana trong thực tế.
