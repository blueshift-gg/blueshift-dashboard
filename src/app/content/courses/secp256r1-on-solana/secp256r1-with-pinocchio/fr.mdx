...
La structure `Secp256r1SignatureOffsets` agit comme une carte mémoire, contenant des décalages (_offsets_) d'octets qui pointent vers l'emplacement de chaque composant dans la charge utile (_payload_) de l'instruction :
