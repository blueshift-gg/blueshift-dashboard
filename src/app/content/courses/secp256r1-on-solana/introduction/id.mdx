...
Secp256r1 kemudian diadopsi oleh NIST sebagai P-256 dan menjadi bagian dari FIPS 186-2. Standardisasi ganda oleh SECG dan NIST memberikan legitimasi luas pada kurva ini dan menyebabkan adopsinya di berbagai protokol dan aplikasi—menjadikannya salah satu kurva yang paling teruji dalam sistem produksi di seluruh dunia.
...
Kurva ini beroperasi pada bidang prima 𝔽p, di mana: `p = 2^256 - 2^224 + 2^192 + 2^96 - 1`.
...
Sementara kurva itu sendiri didefinisikan pada medan koordinat 𝔽p, kunci privat berada dalam ruang matematis yang berbeda: medan skalar 𝔽n, di mana n adalah orde kurva.
...
- Ini adalah moduli yang berbeda: `n ≠ p`
...
Proses onboarding dompet tradisional mengalami tingkat pengguna yang berhenti sebesar 60-80% karena seed phrase menuntut keamanan sempurna dari manusia yang tidak sempurna. Pengguna harus menghafal 12-24 kata acak, menyimpannya dengan aman selamanya, dan tidak pernah menjadi korban phishing—standar yang mustahil untuk adopsi massal.
