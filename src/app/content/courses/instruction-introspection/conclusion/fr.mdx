...
- Les bonnes pratiques pour la vérification des programmes, la validation des comptes et le _parsing_ des données
...
- Le _parsing_ des données et application des contraintes
