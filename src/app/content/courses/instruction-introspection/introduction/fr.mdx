...
- les comptes avec lesquels elle interagit (y compris les métadonnées telles que signataire/modifiable en écriture (_writable_)),
...
<ArticleSection
  name="Contraintes Courantes pour l'Introspection"
