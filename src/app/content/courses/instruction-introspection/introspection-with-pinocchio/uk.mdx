...
З цієї причини ми можемо використовувати _Інтроспекцію інструкцій_ у Pinocchio без встановлення зовнішніх крейтів і отримувати доступ до всієї необхідної інформації, імпортуючи ці функції:
