...
Vì lý do này, chúng ta có thể sử dụng _Instruction Introspection_ trong Pinocchio mà không cần cài đặt bất kỳ crate bên ngoài nào và có thể truy cập tất cả thông tin chúng ta cần bằng cách import các hàm này:
