...
Untuk alasan ini, kita dapat menggunakan _Instruksi Introspeksi_ di Pinocchio tanpa menginstal crate eksternal dan dapat mengakses semua informasi yang kita butuhkan dengan mengimpor fungsi-fungsi ini:
