...
Aus diesem Grund können wir _Instruktions-Introspektion_ in Pinocchio verwenden, ohne externe Crates zu installieren, und können auf alle benötigten Informationen zugreifen, indem wir diese Funktionen importieren:
