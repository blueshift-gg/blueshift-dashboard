...
For this reason, we can use _Instruction Introspection_ in Pinocchio without installing any external crates and can access all the information we need by importing these functions:
