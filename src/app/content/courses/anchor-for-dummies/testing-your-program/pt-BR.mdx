...
Cobrimos a configuração do lado do cliente em detalhes [aqui](/pt-BR/courses/anchor-for-dummies/client-side-development).
...
Cobrimos testes com Mollusk em detalhes [aqui](/pt-BR/courses/testing-with-mollusk).
...
Cobrimos testes com LiteSVM em detalhes [aqui](/pt-BR/courses/testing-with-litesvm).

Você pode configurar seu provider do Anchor e usar a configuração do lado do cliente que vimos [anteriormente](/pt-BR/courses/anchor-for-dummies/client-side-development) com o pacote `anchor-litesvm`.
...
Cobrimos a configuração e uso do Surfnet em detalhes [aqui](/pt-BR/courses/testing-with-surfpool).
