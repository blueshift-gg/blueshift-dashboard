...
> A migração quebra todos os PDAs existentes, pois eles são derivados do Program ID antigo. Os usuários devem atualizar suas aplicações para usar o novo endereço e alterar a autoridade sobre qualquer token account cuja autoridade seja um PDA.
