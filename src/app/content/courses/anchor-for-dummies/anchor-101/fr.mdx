...
![Introduction à Anchor](/graphics/course-banners/anchor-for-dummies.png)
...
Pour ce faire, il utilise une combinaison de types de comptes et d'attributs _inline_.
...
- `SystemAccount<'info>`: Confirme que le Programme Système (_System Program_) est propriétaire du compte.
...
- `seeds & bump`: Vérifie que le compte est une Adresse Dérivée de Programme (_Program-Derived Address_ ou PDA) générée à partir des seeds fournies et d'un octet de saut (_bump_).
