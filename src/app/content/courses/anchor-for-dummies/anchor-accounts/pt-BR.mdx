...
Se você quiser aprender mais sobre como usar `anchor-spl`, pode seguir os cursos [SPL-Token Program with Anchor](/pt-BR/courses/spl-token-with-anchor) ou [Token2022 Program with Anchor](/pt-BR/courses/token-2022-with-anchor).
