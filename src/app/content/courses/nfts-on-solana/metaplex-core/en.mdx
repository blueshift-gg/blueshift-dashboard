...
# Metaplex Core and Compressed NFTs
...
1. How many NFTs? (<10K: any standard. >100K: consider compressed)
...
Small collections (<10K), maximum compatibility desired: **Token Metadata**

Small collections, cost-conscious, modern stack: **Core**

Large collections (>100K), gaming, loyalty programs: **Compressed NFTs**
