...
console.log(
  `Mint criada! Confira sua TX aqui: https://explorer.solana.com/tx/${signature}?cluster=devnet`,
);
```
...
console.log(
  `Token accounts criadas! Confira sua TX aqui: https://explorer.solana.com/tx/${signature}?cluster=devnet`,
);
```
