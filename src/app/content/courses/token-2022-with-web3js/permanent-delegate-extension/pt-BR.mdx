...
console.log(
  `Mint criado! Confira sua TX aqui: https://explorer.solana.com/tx/${signature}?cluster=devnet`,
);
```
...
console.log(
  `Mint fechado! Confira sua TX aqui: https://explorer.solana.com/tx/${signature}?cluster=devnet`,
);
```
