...
Lorsque nous voulons activer certains des comportements bloqués par le _Cpi guard_, nous pouvons facilement le désactiver à l'aide de l'instruction `disableCpiGuard` comme ceci :
