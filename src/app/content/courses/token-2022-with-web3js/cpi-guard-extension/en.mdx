...
To initialize the `CpiGuard` extension on a `Token` account we're going to need the `enableCpiGuard()` function.

Here's how to create a token with the Cpi Guard extension:
