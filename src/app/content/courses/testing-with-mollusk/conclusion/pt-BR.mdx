...
1. Pratique com Programas Reais: Aplique seu conhecimento do Mollusk para testar seus [Programas Anchor](/en/courses/anchor-for-dummies/testing-your-program#mollusk-tests) ou [Programas Pinocchio](/en/courses/introduction-to-pinocchio/testing-your-program#mollusk-tests)
2. Explore os Desafios: Visite a [seção de Desafios](/en/challenges) para exercícios práticos que ajudarão você a aplicar suas habilidades de teste com o Mollusk
