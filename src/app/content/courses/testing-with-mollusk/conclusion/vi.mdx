...
1. Thực hành với Chương trình thực tế: Áp dụng kiến thức Mollusk của bạn để kiểm thử các chương trình [Anchor Programs](/vi/courses/anchor-for-dummies/testing-your-program#mollusk-tests) hoặc [Pinocchio Programs](/vi/courses/introduction-to-pinocchio/testing-your-program#mollusk-tests) của bạn
...
> Đặc biệt cảm ơn Mohammed Zeeshan đã thực hiện công việc ban đầu về nội dung mà bạn có thể tìm thấy trong [repo này](https://github.com/alizeeshan1234/mollusk_testing)
