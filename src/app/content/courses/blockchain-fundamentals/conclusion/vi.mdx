...
Blockchains thay thế các trung gian đáng tin cậy bằng việc tính toán có thể xác minh. Thay vì hỏi "chúng ta tin ai?", blockchain hỏi "các hành vi nào được khuyến khích?" Khi chi phí tấn công vượt quá lợi ích tấn công, các bên tham gia đường nhiên sẽ chọn trung thực. Toán học phát hiện gian lận. Kinh tế ngăn chặn nó.
