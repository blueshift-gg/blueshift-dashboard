...
[O problema do gasto duplo](/courses/blockchain-fundamentals/digital-trust-problem) parecia matematicamente impossível — dinheiro digital sem uma autoridade central. A solução combina três ferramentas matemáticas que existem há décadas. O avanço foi conectá-las em um único protocolo.
