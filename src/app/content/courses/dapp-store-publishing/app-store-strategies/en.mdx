...
<ArticleSection
  name="Apple App Store: The Stricter Gatekeeper"
  id="apple-app-store-the-stricter-gatekeeper"
  level="h2"
/>
...
<ArticleSection
  name="Solving the Test Account Problem"
  id="solving-the-test-account-problem"
  level="h2"
/>
...
<ArticleSection
  name="Google Play: Different Challenges"
  id="google-play-different-challenges"
  level="h2"
/>
...
<ArticleSection
  name="Avoiding Common Rejection Reasons"
  id="avoiding-common-rejection-reasons"
  level="h2"
/>
