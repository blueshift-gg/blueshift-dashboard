...
<ArticleSection
  name="Apple App Store: O Gatekeeper Mais Rigoroso"
  id="apple-app-store-o-gatekeeper-mais-rigoroso"
  level="h2"
/>
...
<ArticleSection
  name="Resolvendo o Problema da Conta de Teste"
  id="resolvendo-o-problema-da-conta-de-teste"
  level="h2"
/>
...
<ArticleSection
  name="Google Play: Desafios Diferentes"
  id="google-play-desafios-diferentes"
  level="h2"
/>
...
<ArticleSection
  name="Evitando Motivos Comuns de Rejeição"
  id="evitando-motivos-comuns-de-rejeicao"
  level="h2"
/>
