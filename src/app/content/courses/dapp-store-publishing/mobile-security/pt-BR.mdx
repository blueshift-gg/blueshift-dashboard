...
<ArticleSection
  name="A Realidade da Engenharia Reversa"
  id="the-reverse-engineering-reality"
  level="h2"
/>
...
<ArticleSection
  name="Quais Segredos Você Pode Realmente Proteger?"
  id="what-secrets-can-you-actually-protect"
  level="h2"
/>
...
<ArticleSection
  name="Proteção contra Ataques Comuns"
  id="protecting-against-common-attacks"
  level="h2"
/>
