...
<ArticleSection
  name="The Reverse Engineering Reality"
...
<ArticleSection
  name="What Secrets Can You Actually Protect?"
...
<ArticleSection
  name="Protecting Against Common Attacks"
...
if (isDeviceCompromised()) {
  // Option 1: Warn user
  Alert.alert("Security Warning", "This device may be compromised. Proceed with caution.");
