...
> Avec les Extensions de Jetons et le [programme Token2022](/en/courses/token-2022-program), la situation change. L'extension Metadata (_Metadata extension_) vous permet d'intégrer des métadonnées directement dans le compte de Mint, éliminant ainsi le besoin de programmes externes.
