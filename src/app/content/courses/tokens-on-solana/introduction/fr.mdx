...
- Jetons _Security_: représentent la propriété d'actifs réels tels que des actions d'entreprise, des biens immobiliers ou des matières premières, mais sous forme numérique.
...
<ArticleSection
  name="Différence par rapport aux autres blockchains"
  id="difference-between-other-blockchains"
  level="h2"
/>
...
Pour chaque jeton, Ethereum nécessite le déploiement d'un contrat intelligent (_smart contract_) qui contient toute la logique du jeton, la gestion de l'état et les règles de transfert.
