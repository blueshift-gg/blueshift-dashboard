...
<ArticleSection name="O Gargalo da Execução Sequencial" id="sequential-execution-bottleneck" level="h2" />
...
<ArticleSection name="Por Que Blocos Rápidos Não Funcionam" id="why-fast-blocks-dont-work" level="h2" />
...
<ArticleSection name="O Trilema da Blockchain Revisitado" id="blockchain-trilemma-revisited" level="h2" />
