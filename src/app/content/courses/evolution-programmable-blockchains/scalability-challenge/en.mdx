...
# The Blockchain Scalability Problem: Why is Ethereum Slow?
...
Ethereum is slow because of sequential execution. [The EVM](/courses/evolution-programmable-blockchains/ethereum-programmable-money#ethereum-virtual-machine) processes one transaction at a time. Network congestion is market pricing of scarce block space. [Bitcoin's 7 TPS](/courses/blockchain-fundamentals/bitcoin-first-blockchain#bitcoin-design-philosophy) and Ethereum's 15 TPS hit the same wall: sequential processing limits throughput.
...
Blockchain throughput is 1,000 to 10,000 times slower than traditional payment systems. As adoption grows, this bottleneck constrains which applications are feasible.
