...
<ArticleSection
  name="Entrypoint und erste Validierung"
...
<ArticleSection
  name="Bedingte Logik und Verzweigung"
...
Dieses kleine Programm erreicht mit nur `4 CUs` im Erfolgsfall, `6 CUs` im Fehlerfall oder `106 CUs`
im Fehlerfall mit Protokollierung einer Fehlermeldung, was in Rust Dutzende von CUs benötigen würde.
