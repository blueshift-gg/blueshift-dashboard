...
<ArticleSection
  name="Điểm đầu vào và Xác thực ban đầu"
...
<ArticleSection
  name="Logic điều kiện và phân nhánh"
...
Chương trình nhỏ này thực hiện được nhưng việc tương tự mà Rust phải tốn hàng chục đơn vị tính toán
với chỉ `4 CUs` trong trường hợp thành công, `6 CUs` trong trường hợp thất bại, hoặc `106 CUs` trong
trường hợp thất bại và ghi log thông báo lỗi.
