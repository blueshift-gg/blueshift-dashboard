...
<ArticleSection
  name="Point d'entrée et validation initiale"
  id="entrypoint-and-validations"
  level="h2"
/>
...
<ArticleSection
  name="Logique conditionnelle et branchement"
...
<ArticleSection
  name="Gestion des erreurs et journalisation"
...
Ce petit programme accomplit ce qui pourrait prendre des dizaines de CUs en Rust avec seulement `4
CUs` dans un cas de réussite, `6 CUs` dans un cas d'échec, ou `106 CUs` dans un cas d'échec qui
