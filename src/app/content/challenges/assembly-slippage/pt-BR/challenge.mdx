...
<ArticleSection
  name="Lógica Condicional e Desvio"
  id="conditional-logic-and-branching"
  level="h2"
/>
...
Este programa minúsculo realiza o que poderia custar dezenas de CUs em Rust com apenas `4 CUs` no
caso de sucesso, `6 CUs` no caso de falha, ou `106 CUs` no caso de falha que registra uma mensagem
de erro.
