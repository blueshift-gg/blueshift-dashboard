...
<ArticleSection
  name="Entrypoint and Initial Validation"
...
<ArticleSection
  name="Conditional Logic and Branching"
...
This tiny program accomplishes what might take Rust tens of CUs with just `4 CUs` in a pass case, `6
CUs` in a fail case, or `106 CUs` in a fail case that logs an error message.
