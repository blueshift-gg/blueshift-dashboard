...
- Übertrage die Beträge aus den Tresoren auf die Token-Konten des Benutzers und verbrenne die entsprechende Menge an LP-Tokens vom Token-Konto des Benutzers. Genau wie in der `Deposit`-Instruction verwendest du einen einzelnen `Batch`, damit beide Transfers und das Burn in einem CPI ausgeführt werden.
