...
Berkat upgrade [`p-token`](https://solana.com/upgrades/p-token), kita bisa membatch transfer token dan minting dalam satu CPI, alih-alih melakukan tiga panggilan CPI terpisah.
