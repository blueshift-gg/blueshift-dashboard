...
- `token program`: Рахунок програми SPL Token. Він потрібен для токен-операцій, таких як transfer і minting. Має бути `executable`.
...
- Перекажіть суми з сховищ на токен-рахунки користувача та спаліть відповідну кількість LP токенів з токен-рахунку користувача. Так само, як і в інструкції `Deposit`, використай один `Batch`, щоб обидва transfer і burn були виконані в одному CPI.
