...
- Transférer les montants des comptes de jetons de l'utilisateur vers les _vaults_ et minter le montant approprié de jetons LP sur le compte de jetons de l'utilisateur.

Grâce à la mise à niveau [`p-token`](https://solana.com/upgrades/p-token), nous pouvons batcher les transferts de jetons et le mint en un seul CPI, au lieu d'effectuer trois appels CPI séparés.
