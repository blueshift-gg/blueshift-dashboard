...
- Transférer les montants des comptes de jetons de l'utilisateur vers les _vaults_ et mintez le montant approprié de jetons LP sur le compte de jetons de l'utilisateur.
