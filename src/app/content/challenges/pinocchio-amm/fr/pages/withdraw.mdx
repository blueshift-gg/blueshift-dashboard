...
- Transférez les montants des vaults vers les comptes de jetons de l'utilisateur et brûlez le montant approprié de jetons LP du compte de jetons de l'utilisateur. Comme dans l'instruction `Deposit`, utilisez un seul `Batch` pour que les deux transfers et le burn soient effectués dans un seul CPI.
