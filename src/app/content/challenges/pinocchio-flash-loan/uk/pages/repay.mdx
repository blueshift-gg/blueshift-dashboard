...
<ArticleSection name="Required Accounts" id="required-accounts" level="h2" />- `borrower`:
Користувач, який запитав флеш-позику. Він надає ламports для створення рахунку `loan`. Має бути
змінюваним. - `loan`: Тимчасовий рахунок, який використовується для зберігання
`protocol_token_account` та необхідного кінцевого `balance`. Має бути змінюваним, оскільки він буде
закритий наприкінці інструкції.
