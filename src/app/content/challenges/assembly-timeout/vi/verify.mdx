...
<RequirementList>
  <Requirement title="Thử thách 1: Kiểm thử Timeout">
    Chương trình của bạn nên thành công khi slot được truyền vào lớn hơn slot hiện tại. 
  </Requirement>

  <Requirement title="Thử thách 2: Kiểm thử trường hợp thất bại của Timeout">
    Chương trình của bạn nên thất bại khi slot được truyền vào nhỏ hơn slot hiện tại.
  </Requirement>
</RequirementList>
