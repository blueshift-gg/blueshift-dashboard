...
Là encore, nous allons vous laisser voler de vos propres ailes et créer votre propre logique ! N'hésitez pas à consulter les sections précédentes pour voir comment nous avons implémenté les instructions _make_ et _take_ instruction ou à nous contacter sur Discord si vous êtes bloqué.
